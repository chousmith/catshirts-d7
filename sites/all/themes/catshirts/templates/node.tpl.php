...
/* TWITTER CARD */
	...
	$element = array(
	  ...
	  '#attributes' => array(
		'name' => 'twitter:url',
		'content' => url($uri['path'], array('absolute'=>true)),
	  ),
	);
	...
	$element = array(
	  ...
	  '#attributes' => array(
		'name' => 'twitter:domain',
		'content' => url('', array('absolute'=>true)),
	  ),
	);
	...
	drupal_add_html_head($element, 'tw_6_image');
	$element = array(
	  '#tag' => 'meta',
	  '#attributes' => array(
	...
	drupal_add_html_head($element, 'tw_7_imagew');
	$element = array(
	  '#tag' => 'meta',
	  '#attributes' => array(
	...
	$hd = drupal_add_html_head($element, 'tw_8_imageh');
		}
	}
	//echo '<pre style="display: none">'. print_r($hd,true) .'</pre>';
?>
